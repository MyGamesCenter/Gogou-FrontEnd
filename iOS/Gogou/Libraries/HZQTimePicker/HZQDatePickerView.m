...
@property (assign, nonatomic) IBOutlet UIButton *cannelBtn;
@property (assign, nonatomic) IBOutlet UIButton *sureBtn;
@property (assign, nonatomic) IBOutlet UIView *backgVIew;
...
- (void)awakeFromNib
{
    ...
    self.sureBtn.layer.borderColor = [BACKGROUND_CORLOR CGColor];
    self.sureBtn.layer.masksToBounds = YES;
    
    /** 取消按钮 */
    self.cannelBtn.layer.cornerRadius = 3;
    self.cannelBtn.layer.borderWidth = 1;
    self.cannelBtn.layer.borderColor = [BACKGROUND_CORLOR CGColor];
