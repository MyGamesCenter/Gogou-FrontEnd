...
- (void)viewDidLoad {
    ...
    [self readSubscriberInfoFromLocalStorage];
...
- (void) readSubscriberInfoFromLocalStorage{
    
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    
    if ([userDefaults dictionaryForKey:@"subscriberInfoDictionary"] != NULL){
        NSDictionary *subscriberInfoDictionary = [userDefaults dictionaryForKey:@"subscriberInfoDictionary"];
        subscriber = [Subscriber new];
        subscriber.Id = [subscriberInfoDictionary objectForKey:@"Id"];
        subscriber.userName = [subscriberInfoDictionary objectForKey:@"userName"];
        subscriber.emailAddress = [subscriberInfoDictionary objectForKey:@"emailAddress"];
        subscriber.clearPassword = [subscriberInfoDictionary objectForKey:@"clearPassword"];
        subscriber.isPurchaser = [subscriberInfoDictionary objectForKey:@"isPurchaser"];
        subscriber.age = [subscriberInfoDictionary objectForKey:@"age"];
        subscriber.imToken = [subscriberInfoDictionary objectForKey:@"imToken"];
        subscriber.imCode = [subscriberInfoDictionary objectForKey:@"imCode"];
        subscriber.gender = [subscriberInfoDictionary objectForKey:@"gender"];
        subscriber.gcmToken = [subscriberInfoDictionary objectForKey:@"gcmToken"];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0){
        UINib *nib = [UINib nibWithNibName:@"MyCollectionTableViewCell" bundle:nil];
        [tableView registerNib:nib forCellReuseIdentifier:@"MyCollectionTableViewCell"];
        MyCollectionTableViewCell *tmp = [tableView dequeueReusableCellWithIdentifier:@"MyCollectionTableViewCell"  forIndexPath:indexPath];
