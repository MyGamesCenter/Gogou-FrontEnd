//
//  RequestPreviewViewController.m
//  worldshopping2.0
//
...
#import "RequestPreviewViewController.h"
...
@interface RequestPreviewViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation RequestPreviewViewController
...
- (void)initData{
    ...
    DetailCellContent *c6 = [[DetailCellContent alloc]initWithKey:@"收货地" andValue:_requirement.receipePlaceName];
    DetailCellContent *c7 = [[DetailCellContent alloc]initWithKey:@"原产地" andValue:_requirement.originName];
    ...
    DetailCellContent *c10 = [[DetailCellContent alloc]initWithKey:@"详细描述" andValue:_requirement.detail];
