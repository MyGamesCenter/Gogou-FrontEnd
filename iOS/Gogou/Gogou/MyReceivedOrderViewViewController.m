//
//  MyReceivedOrderViewViewController.m
//  Gogou
//
...
@interface MyReceivedOrderViewViewController (){
...
@implementation MyReceivedOrderViewViewController
...
- (void) segmentedControlInit{
    ...
    orderFilter.sellerId = subscriber.userName;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (orderList.count != 0){
        ...
        [tmp setupCellWith:order AndImagePath:imagePath AndIsDemander:NO];
