...
- (void)awakeFromNib {
    ...
    [self.segmentController setTitle:NSLocalizedString(@"收藏需求", nil) forSegmentAtIndex:0];
    [self.segmentController setTitle:NSLocalizedString(@"收藏行程", nil) forSegmentAtIndex:1];
